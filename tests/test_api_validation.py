...
def test_mock_bedrock_api_matches_real_structure(mock_bedrock_api):
    ...
    """
    real_api_url = "https://net-secondary.web.minecraft-services.net/api/v1.0/download/links"
    ...
    for r_type in real_types:
        assert r_type in mock_types, f"Upstream API added new downloadType: {r_type}, but it is missing from mock!"
